...
def _extract_and_validate_params(matching_tool: dict,
    ...
    for message in messages:
        ...
        # Skip user messages (no conversion needed)
            ...
            if tool_result_match:
                ...
                converted_messages.append({
                    ...
                    'tool_call_id':
                    f'toolu_{tool_call_counter - 1:02d}',  # Use last generated ID
                })
            else:
                converted_messages.append({'role': 'user', 'content': content})
        ...
        # Handle assistant messages
            ...
            if fn_match:
                ...
                tool_call = {
                    'index':
                    1,  # always 1 because we only support **one tool call per message**
                    'id': tool_call_id,
                    'type': 'function',
                    'function': {
                        'name': fn_name,
