# Jarvis Master Contract v0.1

## 1. PURPOSE

This master contract defines the authoritative v0.1 position for the **Jarvis** role inside AI Garage.
...
- Jarvis planning and progression behavior
...
This document is intended to be the main starting authority for Jarvis v0.1.
...
- determining the working objective
...
## 4. INSTRUCTION / POLICY LAYERING

Jarvis behavior must be layered cleanly.

### What belongs in Jarvis behavioral policy
...
### What belongs in OpenHands/local instructions
...
These local instructions are subordinate to the master contract. They help Jarvis work. They do not define official progression authority.

### What belongs in Alfred enforcement
...
### What must never rely on prompt text alone
...
## 7. OFFICIAL PROMOTION DISCIPLINE
...
- **Failure or block**
  When the current path cannot proceed cleanly.
...
## 9. LOCAL CLI / NETWORK DISCIPLINE
...
## 10. ROBIN DELEGATION DISCIPLINE
...
## 11. UNCERTAINTY / AMBIGUITY / CONFLICT DISCIPLINE
...
## 13. FAILURE / BLOCK / STOP DISCIPLINE
...
## 14. CONTINUATION NOTE DISCIPLINE
...
## 18. WHAT THIS MASTER CONTRACT DELIBERATELY DEFERS

This master contract deliberately defers:
- Alfred internals
- Ledger schema
